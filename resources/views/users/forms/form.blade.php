        ...
        <div class="row">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Name</label><input name="name" type="text" class="form-control" placeholder="" value="{{ $user['name'] }}"></div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels">Skills</label><input name="skills" type="text" class="form-control" placeholder="Enter your skills here" value="@if ($user['skills'] != null) @foreach ($user['skills'] as $skill) {{ $skill }} @endforeach @endif"></div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-3"> 
                        <a href="" style="text-decoration: underline; color:blue;"><small>Change Password</small></a>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">City</label><input name="street_address" type="text" class="form-control" placeholder="Enter Street Address" value="{{ $user['street_address'] }}"></div>
                    <div class="col-md-12"><label class="labels">Zip</label><input name="zip" type="text" class="form-control" placeholder="Enter your Zip Code" value="{{ $user['zip'] }}"></div>
                </div>
                <div class="row mt-3">
